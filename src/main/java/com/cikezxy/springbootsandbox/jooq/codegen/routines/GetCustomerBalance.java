...
public class GetCustomerBalance extends AbstractRoutine<BigDecimal> {
    ...
    private static final long serialVersionUID = 1389631671;

    /**
     * The parameter <code>sakila.get_customer_balance.RETURN_VALUE</code>.
     */
    public static final Parameter<BigDecimal> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.DECIMAL(5, 2), false, false);
    ...
    public GetCustomerBalance() {
        super("get_customer_balance", Sakila.SAKILA, org.jooq.impl.SQLDataType.DECIMAL(5, 2));
