...
import com.cikezxy.springbootsandbox.jooq.codegen.enums.FilmRating;
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.FilmRecord;
...
public class Film extends TableImpl<FilmRecord> {
    ...
    private static final long serialVersionUID = -2118276053;
     ...
     */
    public final TableField<FilmRecord, UByte> RENTAL_DURATION = createField("rental_duration", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(DSL.inline("3", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "");

    /**
     * The column <code>sakila.film.rental_rate</code>.
     */
    public final TableField<FilmRecord, BigDecimal> RENTAL_RATE = createField("rental_rate", org.jooq.impl.SQLDataType.DECIMAL(4, 2).nullable(false).defaultValue(DSL.inline("4.99", org.jooq.impl.SQLDataType.DECIMAL)), this, "");
     ...
     */
    public final TableField<FilmRecord, BigDecimal> REPLACEMENT_COST = createField("replacement_cost", org.jooq.impl.SQLDataType.DECIMAL(5, 2).nullable(false).defaultValue(DSL.inline("19.99", org.jooq.impl.SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>sakila.film.rating</code>.
     */
    public final TableField<FilmRecord, FilmRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR(5).defaultValue(DSL.inline("G", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(FilmRating.class), this, "");
     ...
     */
    public final TableField<FilmRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
