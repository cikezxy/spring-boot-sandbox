...
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.CountryRecord;
...
public class Country extends TableImpl<CountryRecord> {
    ...
    private static final long serialVersionUID = -866935685;
     ...
     */
    public final TableField<CountryRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
