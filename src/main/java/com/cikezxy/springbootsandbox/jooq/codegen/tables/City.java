...
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.CityRecord;
...
public class City extends TableImpl<CityRecord> {
    ...
    private static final long serialVersionUID = 1141984781;
     ...
     */
    public final TableField<CityRecord, UShort> CITY_ID = createField("city_id", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<CityRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
    ...
    public Country country() {
        return new Country(this, Keys.FK_CITY_COUNTRY);
    }
