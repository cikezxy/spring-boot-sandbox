...
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.CategoryRecord;
...
public class Category extends TableImpl<CategoryRecord> {
    ...
    private static final long serialVersionUID = -959628870;
     ...
     */
    public final TableField<CategoryRecord, UByte> CATEGORY_ID = createField("category_id", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<CategoryRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
