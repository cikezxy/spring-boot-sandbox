...
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.ActorRecord;
...
public class Actor extends TableImpl<ActorRecord> {
    ...
    private static final long serialVersionUID = 1133143642;
     ...
     */
    public final TableField<ActorRecord, UShort> ACTOR_ID = createField("actor_id", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<ActorRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
