...
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.PaymentRecord;
...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    private static final long serialVersionUID = -35374262;
     ...
     */
    public final TableField<PaymentRecord, UShort> PAYMENT_ID = createField("payment_id", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<PaymentRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
    ...
    public Customer customer() {
        return new Customer(this, Keys.FK_PAYMENT_CUSTOMER);
    }

    public Staff staff() {
        return new Staff(this, Keys.FK_PAYMENT_STAFF);
    }

    public Rental rental() {
        return new Rental(this, Keys.FK_PAYMENT_RENTAL);
    }
