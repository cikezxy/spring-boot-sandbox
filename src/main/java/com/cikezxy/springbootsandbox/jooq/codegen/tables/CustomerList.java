...
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.CustomerListRecord;
...
public class CustomerList extends TableImpl<CustomerListRecord> {
    ...
    private static final long serialVersionUID = -797845406;
     ...
     */
    public final TableField<CustomerListRecord, UShort> ID = createField("ID", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED)), this, "");
     ...
     */
    public final TableField<CustomerListRecord, String> NOTES = createField("notes", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
