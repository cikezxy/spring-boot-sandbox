...
import com.cikezxy.springbootsandbox.jooq.codegen.tables.records.LanguageRecord;
...
public class Language extends TableImpl<LanguageRecord> {
    ...
    private static final long serialVersionUID = -1232983084;
     ...
     */
    public final TableField<LanguageRecord, UByte> LANGUAGE_ID = createField("language_id", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<LanguageRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
